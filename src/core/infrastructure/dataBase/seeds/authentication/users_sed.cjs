...
exports.seed = async function (knex) {
  ...
  await knex('users').insert([
    ...
    { id: 3, user: 'admin', password: '$2a$10$ZeOv7/NVULy60cY/6TBxLeWKy3X9ztiYRGu3PT9MuMJAERGrDtR.S', is_deleted: 0, created_by: 1 },
    { id: 4, user: 'test_user', password: 'password', is_deleted: 0, created_by: 2 },
  ]);
};
